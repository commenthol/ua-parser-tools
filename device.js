...
var
  deviceParser = require(config.ua_parser + '/device'),
...
var options = {
  file:      "useragents.txt",
  testcasesin:  __dirname + '/' + config.test_resources.dir + '/' + config.test_resources.device,
  testcasesout: __dirname + '/' + config.output.dir + '/' + config.test_resources.device,
  listfile: "device.csv",
  logfile:  "device.log",
  console:   false,
  family:    true,
...
if (require.main === module) {
  var errmsg = 'Usage: (e.g.)\n' +
    '  node device.js file:uas.txt testcases:true';
